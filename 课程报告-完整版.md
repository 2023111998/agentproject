...
> 📸 **截图位置 #1 — Prometheus Targets 状态**：http://localhost:9091/targets → `screenshots/prometheus-targets.png`
> 📸 **截图位置 #2 — Grafana 仪表盘全览**：Grafana campus-sla-dashboard → `screenshots/grafana-overview.png`
> 📸 **截图位置 #3 — Grafana 服务层指标**：`screenshots/grafana-service-metrics.png`
> 📸 **截图位置 #4 — Grafana JVM 资源**：`screenshots/grafana-jvm-resources.png`
> 📸 **截图位置 #5 — Grafana SLA 明细表**：`screenshots/grafana-sla-table.png`
...
> 📸 截图文件: `screenshots/grafana-overview.png` | `screenshots/grafana-service-metrics.png` | `screenshots/grafana-jvm-resources.png` | `screenshots/grafana-sla-table.png`
